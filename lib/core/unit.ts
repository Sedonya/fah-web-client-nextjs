...
class Unit {
  ...
  get assign_time() {
    return this.util.since(this.assign.time) + ' ago'
  }
  ...
  get_field_content(name: string)       {return (this as any)[clean_field(name)]}
  ...
  get_field_title(name: string) {
    return (this as any)[clean_field(name) + '_title'] || Unit.get_field_desc(name)
  }
